...
// -- Sidebar, Trigger, Rail, Inset, Input, Header, Footer, Separator, Content, Group, GroupLabel, GroupAction, GroupContent --
...
// The rest of the Sidebar components like Rail, Inset, Input, Header, Footer, Separator, Content, Group, Menu, MenuButton, etc. can be kept exactly the same, just remove the TS types.
